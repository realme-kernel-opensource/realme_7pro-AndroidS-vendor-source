/******************************************************************************
 *
 *  $Id: AKManualCal.h 367 2016-04-01 06:42:49Z suzuki.thj $
 *
 * -- Copyright Notice --
 *
...
int16 AKSC_GetGyroOffsetAuto(
    ...
    const int16    gMaxDif,            //(i)   : Thresould for maximum difference value to detect stable in Q4[dps], must be over 0.
