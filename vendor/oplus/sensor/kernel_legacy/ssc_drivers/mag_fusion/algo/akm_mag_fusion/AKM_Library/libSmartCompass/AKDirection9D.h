/******************************************************************************
 *
 *  $Id: AKDirection9D.h 367 2016-04-01 06:42:49Z suzuki.thj $
 *
 * -- Copyright Notice --
 *
...
//========================= Constant definition =========================//
#define AKSC_FIXED_6D_BASED_MODE    2    // setting value definition for AKSC_D9D_setParams when paramsID is AKSC_D9D_ID_FIXED_MODE
#define AKSC_FIXED_GYRO_BASED_MODE  1    // setting value definition for AKSC_D9D_setParams when paramsID is AKSC_D9D_ID_FIXED_MODE
#define AKSC_FIXED_MODE_OFF         0    // setting value definition for AKSC_D9D_setParams when paramsID is AKSC_D9D_ID_FIXED_MODE
...
int16 AKSC_Direction9D(
    ...
    const int16vec  *h,         //(i)   : Geomagnetic vector (offset and sensitivity are compensated), AKSC format
    const int16vec  *a,         //(i)   : Acceleration vector (offset and sensitivity are compensated), AKSC format
    const int16vec  *g,         //(i)   : Angular rate vector (offset and sensitivity are compensated), [dps]
...
// AKSC_D9D_ID_FIXED_MODE               :   AKSC_FIXED_MODE_OFF [-] or AKSC_FIXED_6D_BASED_MODE [-] or AKSC_FIXED_GYRO_BASED_MODE [-]
/////////////////////////////////////////////////////////////////////////////////////////////////////
