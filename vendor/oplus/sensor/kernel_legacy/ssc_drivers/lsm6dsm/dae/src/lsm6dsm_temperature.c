                      ...
                      int32_t*            num_samples )
{
  ...
  {
    { .reg_addr = STM_LSM6DSM_REG_STATUS,
      .buf_sz   = 1 },
    { .reg_addr = STM_LSM6DSM_REG_OUT_TEMP_L,
      .buf_sz   = 2 },
  };
...
sns_dd_if_s lsm6dsm_temperature_hal_table =
  { .get_data         = get_temperature_data,
    .parse_accel_data = NULL };

sns_dd_if_s lsm6dsm_temperature_hal_table2 =
  { .get_data         = get_temperature_data,
    .parse_accel_data = NULL };
